...
export default defineConfig({
    ...
    // },
    optimizeDeps: {
        include: ['lodash', 'react-confirm-alert', 'react-redux', 'react-dom','dayjs/plugin/relativeTime', '@toast-ui/editor', '@toast-ui/editor/dist/toastui-editor-viewer'],
        esbuildOptions: {
    ...
    server: {
        allowedHosts: ["localhost", "admin-ui.local"],
        proxy: {
            '/api/': {
